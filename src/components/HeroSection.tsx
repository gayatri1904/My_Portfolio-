...
const HeroSection: React.FC = () => {
    ...
    const text = useTypewriter({
        words: ["Full-stack developer", "Software Developer", "Frontend Developer", "Backend Developer"],
        typingSpeed: 100,
        deletingSpeed: 50,
    ...
    const SocialLinks = [
        {
            href: "https://github.com/gayatri1904/",
            icon: <Github size={24} />
        },
        {
            href: "https://www.linkedin.com/in/gayatri-jadhav-895268226",
